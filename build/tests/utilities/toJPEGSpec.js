...
var JPEG_1 = __importDefault(require("../../utilities/JPEG"));
describe('Test image processing', function () {
    it('should return the resized version of the image with specific width and height', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, JPEG_1.default)(srcFilePath, 250, 250, dstFilePath)];
                case 1:
                    _a.sent();
